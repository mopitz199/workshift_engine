...
class TestRangeMapperSub(object):
    ...
    def test_sub1(self):
        r1 = RangeMapper(datetime(2019, 5, 5).date(), datetime(2019, 5, 10).date())
        r2 = RangeMapper(datetime(2019, 5, 10).date(), datetime(2019, 5, 17).date())

        r2, new = r2 - r1

        assert (r2.starting_date == datetime(2019, 5, 11).date() and
            r2.ending_date == datetime(2019, 5, 17).date() and new == None)

    def test_sub2(self):
        r1 = RangeMapper(datetime(2019, 5, 5).date(), datetime(2019, 5, 17).date())
        r2 = RangeMapper(datetime(2019, 5, 10).date(), datetime(2019, 5, 13).date())
...
class TestRangeMapperAdd(object):
    ...
    def test_add2(self):
        r1 = RangeMapper(datetime(2019, 5, 5).date(), datetime(2019, 5, 10).date())
        r2 = RangeMapper(datetime(2019, 5, 11).date(), datetime(2019, 5, 17).date())
    ...
    def test_add3(self):
        r1 = RangeMapper(datetime(2019, 5, 5).date(), datetime(2019, 5, 10).date())
        r2 = RangeMapper(datetime(2019, 5, 12).date(), datetime(2019, 5, 17).date())
    ...
    def test_add3(self):
        r1 = RangeMapper(datetime(2019, 5, 5).date(), datetime(2019, 5, 10).date())
        r2 = RangeMapper(datetime(2019, 5, 5).date(), datetime(2019, 5, 10).date())
